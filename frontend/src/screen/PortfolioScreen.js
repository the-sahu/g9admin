      ...
      <div>
          ...
          <table class="mt-2 overflow-y-auto max-h-48 w-full ">
                <thead class=" text-white bg-primary-500">
                    <tr>
                        <th
                            class="   truncate w-24 pl-2 capitalize text-left py-3 text-wrap   font-brand  font-bold text-xs border-gray-700 border">
                        SR <br/> .no
                        </th>
                        <th
                            class="   truncate w-24 pl-2 capitalize text-left py-3 text-wrap   font-brand  font-bold text-xs border-gray-700 border">
          ...
          <table class="mt-2 ">
                <thead class=" text-white ">
                    <tr>
                        <th
                            class=" text-wrap w-32  truncate text-black font-bold text-left py-2 px-4 uppercase font-brand tracking-wide  text-xs border-gray-700 border">
                        Client capital
                        </th>
                        <th
                            class=" text-wrap w-32  truncate text-left py-2 px-4 uppercase font-brand tracking-wide font-bold bg-primary-500 text-xs border-gray-700 border">
                        Net profit
                        </th>
                        <th
                            class=" text-wrap w-32  truncate text-left py-2 px-4 font-bold uppercase font-brand tracking-wide  text-xs bg-red-600 border-gray-700 border">
                        net loss
                        </th>
                ...
                <tbody class="">
                    <tr>
                        <td
                            class=" text-center w-32 py-2 font-bold  px-4 border border-gray-700 text-sm font-brand tracking-wide">
                        20,000
                        </td>
                        <td
                            class=" text-center w-32 font-bold text-primary-500 py-2 px-4 border border-gray-700 text-sm font-brand tracking-wide">
                                5624
                        </td>
                        <td
                            class=" text-center w-32 py-2 px-4 border border-gray-700 text-sm font-bold text-red-600 font-brand tracking-wide">
                                00.00
                        </td>
